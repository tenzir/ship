...
The legacy `--bare` CLI flag and `bare=True` Python parameter remain accepted for compatibility, but now warn that bare semantic versions are already the default output.
